---
title: "Bathymetry Preprocessing - NCEAS Inspired"
author: "BJ"
format: html
---
...
## Original code : Cori Lopazanski, lopazanski@bren.ucsb.edu, Dec 2024
...
- From AG: 2m resolution is very raw, affected by white zones that could not be mapped (shallow, rough seas, heavy kelp). This layer was processed by people in the M. Carr and P. Raimondi labs. Aggregated to 30m resolution and used a linear interpolation on nearshore data.
...
- This layer likely contains deeper areas than the 30m layer above. 
- Metadata provided and data is now likely publicly available (somewhere).
